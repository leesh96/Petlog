...
import navigation.ShareCommentActivity;
...
public class ShareDetailActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //데이터 넘겨주는 값
         ...
         //
        Toast.makeText(getApplicationContext(),idview+"번글"+"제목"+titleview+"내용"+contentview+"닉네임"+nicknameview,Toast.LENGTH_LONG).show();
        ...
        Toast.makeText(getApplicationContext(),"현재로그인된 닉네임 "+user_nick+"님 "+"게시물작성자"+nickname+"님",Toast.LENGTH_LONG).show();

        /**if(user_nick==nickname){
            imgbtn_sharemenu.setVisibility(View.VISIBLE);
        }
        else if(user_nick!=nickname){
            imgbtn_sharemenu.setVisibility(View.GONE);
        }*/
