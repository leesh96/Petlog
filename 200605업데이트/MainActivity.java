...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String nicknameview=nickname;
        ...
        user_nick.setText(idview);
         ...
         change_info=header.findViewById(R.id.change_info);
         change_info.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent editintent= new Intent(MainActivity.this, Change_info_Activity.class);
            editintent.putExtra("userNick",nicknameview);
            startActivity(editintent);
        /**new AlertDialog.Builder(MainActivity.this)
        .setTitle("정보 변경")
        .setMessage("비밀번호 확인이 필요합니다.")
