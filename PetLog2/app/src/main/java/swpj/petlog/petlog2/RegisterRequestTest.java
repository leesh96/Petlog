...
public class RegisterRequestTest extends StringRequest {
    ...
    public RegisterRequestTest(String u_id, String u_pw, String u_name, String u_nickname,String u_bdy, Response.Listener<String> listener) {
