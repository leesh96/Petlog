    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_validateid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ValidateRequestTest validateRequest = new ValidateRequestTest(Id, responseListener);
                RequestQueue queue = Volley.newRequestQueue(RegisterActivityTest.this);
        ...
        editTextBdy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(RegisterActivityTest.this, android.R.style.Theme_Holo_Light_Dialog, myDatePicker, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if(validateid & validatenick) {
                    if (Pw.equals(Pwcheck)) {
                        ...
                        Intent intent = new Intent(RegisterActivityTest.this, SignupDoneActivity.class);
    ...
    private void insertToDatabase(String Id, String Pw, String Name, String Nick, String Bdy) {
        class InsertData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(RegisterActivityTest.this, "Please Wait", null, true, true);
            }
            @Override
